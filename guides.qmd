...
2. **Lysis Buffer:** Add 5–100 mg of tissue to a 2 ml tissue disruption tube. Due to the high phenolic content of *P. crassipes*, **do not** use the standard CD1 volume. Instead, add **450 µl of Solution CD1 and 50 µl of Solution PS**. Vortex briefly to mix.
...
Collaborators are free to use any sequencing facility of their choice and should adhere strictly to the submission parameters established by their selected provider. We strongly recommend aiming for the **highest sequencing depth possible**, depending on the budget available to the collaborator or their host laboratory.

If your facility does not provide specific guidelines, please use the following baseline requirements as a standard reference for DNA sample submission:

* **Total Amount & Quality:** At least 100 ng of high molecular weight (>20 kb) genomic DNA, treated with RNase.
* **Target Concentration:** Diluted to ~5.0–10.0 ng/µl. (Concentrations generally accepted range from a preferred minimum of 0.5 ng/µl to a maximum of 25 ng/µl).
* **Quantification Method:** Samples must be quantified using Qubit, PicoGreen, or another fluorometric assay to ensure accurate results.
